 ...
 * Reuses `HeroWave`'s exact curves (`flip`), mirrored, so the page closes by
 * deliberately echoing the hero's own wave treatment — an intentional
 * bookend — without rendering a pixel-identical copy of the hero.
 */
